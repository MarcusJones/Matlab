...
for i = 1:length(StartEnd(1,:))
    ...
    % Primary energy
    Day.Elec(1,i)...
        = DaySum(Energy.Elec, 0, StartIndx(1), EndIndx(1)).*60; % [kJ]
end
...
Day.Summary = vertcat( ...
    ...
    Day.R.COP_Des, ...
    Day.R.COP_Air, ...
    -Day.R.Wk.WR_DesTOT_Enth./Day.R.HW.dETOT, ... % Regen thermal COP
    -Day.R.Wk.WR_AirTOT_Enth./Day.R.HW.dETOT, ... 
    -Day.C.TC./Day.R.HW.dETOT, ... % Cooling thermal COP
    Day.C.TC./Day.Elec, ...    % Cooling electrical COP
    Day.C.Str.Conc.In, ...
    Day.C.Str.Conc.Out, ...
    Day.C.Str.dC, ...
    Day.R.Wk.Conc.In, ...
