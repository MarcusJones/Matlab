...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Plot 1
x1 = Good.Cool.Temp.In';
x2 = Good.Strong.C.In';
x3 = Good.Air.Amb.T';
y = -Good.Air.Amb.dT';

Variable = 'Change in air temp. ';
Units = 'degrees C';
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Choose model of fit and perform regression
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
X = [ones(size(x1)) x1 x2 x3 x1.*x2.*x3]; % Bi-linear, w/ interaction
b = regress(y,X);
yhat = b(1) + b(2)*x1 + b(3)*x2 + +b(4).*x3 + b(5)*x1.*x2.*x3;
r = y-yhat;
