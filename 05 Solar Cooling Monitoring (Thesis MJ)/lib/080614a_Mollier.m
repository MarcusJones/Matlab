function y=molliernieuw2(time,temp,rh,name,savename,demand,varargin);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% copyright Jos van Schijndel and Marco Martens, Technische Universiteit Eindhoven, The Netherlands
% Modifications made by Marcus Jones June 2008, Queen's University - Canada
%
...
text(20.75,24,'Total Division','Color',1/255*[0 0 0])
line([21.75 21.75],[20.5 23.5],'Color',1/255*[150 150 150])
line([23.25 23.25],[20.5 23.5],'Color',1/255*[150 150 150])
line([20.75 24.25],[21.5 21.5],'Color',1/255*[150 150 150])
line([20.75 24.25],[22.5 22.5],'Color',1/255*[150 150 150])
...
if length(find(tautumn>=0))>=1
    ...
    text(22.5,4,'Autumn Division','Color',1/255*[110 60 6],'HorizontalAlignment','center')
...
if length(find(tsummer>=0))>=1
    ...
    text(22.5,9,'Summer Division','Color',1/255*[201 8 8],'HorizontalAlignment','center')
...
if length(find(tspring>=0))>=1
    ...
    text(22.5,14,'Spring Division','Color',1/255*[11 77 5],'HorizontalAlignment','center')
...
if length(find(twinter>=0))>=1
    ...
    text(22.5,19,'Winter Division','Color',1/255*[3 51 148],'HorizontalAlignment','center')
