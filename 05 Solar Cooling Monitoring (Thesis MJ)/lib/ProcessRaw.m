...
% These are more readable header files

% For three air positions; ambient, process, duct
Air.HdrAmb = char(...
    'Pamb',... 
    'Tamb',...
    'RHamb',...
...
Air.Amb = [...
    ...
    EnthalpyAir(DatedData(:,Tamb_C),Air.Amb(:,4))... % Ambient Enthalpy
    ];
...
Air.Proc = [...
    ...
    EnthalpyAir(DatedData(:,Tprocess),Air.Proc(:,4))... % Process Enthalpy    
    ];
...
Air.Duct = [...
    ...
    EnthalpyAir(DatedData(:,Tcal),Air.Duct(:,4))... % Duct Enthalpy    
    ];
