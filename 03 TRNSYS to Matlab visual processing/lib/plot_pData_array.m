...
startTitleString = datestr(trnTime.time(1), 'dd-mmm-yyyy HH:MM:SS');
endTitleString = datestr(trnTime.time(end), 'dd-mmm-yyyy HH:MM:SS');
...
for nCurrSubPlot = 1:numSubPlots;
    ...
    plot(trnTime.time(trnTime.mask),...
        [...
        pStruct.Data(trnTime.mask,:) ...
        ],'LineWidth',1)
    ...
    set(h(nCurrSubPlot),'XLim',trnTime.time(trnTime.mask));
