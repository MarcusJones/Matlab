...
BASE.Tsetmin{2}=	[   -100,  -100,    -100];
BASE.Tsetmax{2}=	[   100,    100,     100]; 
BASE.RVmin{2}=		[	-1,		-1,		-1	];
...
BASE.Plant{3}=[2000,-2000,0.001,-0.001];
...
%Output=Wavox1204(Control,Profiles,InClimate,InBuil);

% Output contains all calculated data. Weather data are in InClimate. With
% these file the program wavooutput makes some plots. Type 'help_wavooutput2' to
