...
BASE.Con{13}=  [0.13,	0.3,234,										0.04,0.9,0.9];
...
BASE.Glas{4}=	[3.2,		0.03,		0.7,		0.36,		0.36,		3.2		];
...
BASE.wallex{5} = 		[1,      27.0,    1,   		4,    0];  
BASE.wallex{6} = 		[2,      54.0,    6,   		5,    0];  		
BASE.wallex{7} = 		[3,      54.0,    6,   		5,    0]; 
BASE.wallex{8} = 		[4,      54.0,    6,   		5,    0];
...
BASE.window{5} = 		[1,     		8,  		1,        0];  
BASE.window{6} = 		[1,     		3.2,  	2,        0];   
BASE.window{7} = 		[6,     		4.8,  	3,        0];  
BASE.window{8} = 		[7,     		3.2,  	3,        0]; 
...
BASE.vvmax{1}=		[	1, 		1, 		1	];
BASE.Tfc{1}=		[	21, 	21, 	21	];
BASE.Qint{1}=		[	0, 		184.5,	0	];
BASE.Gint{1}=		[	0, 		(200/3.6)*1e-6,	 0	];
BASE.Tsetmin{1}=	[   15,     20,     15  ];
BASE.Tsetmax{1}=	[   24,     24,     24  ]; 
BASE.RVmin{1}=		[	20,		20,		20  ];
BASE.RVmax{1}=		[30,	30,	30	];
...
BASE.Gint{2}=		[	0, 		(200/3.6)*1e-6, 0	];
BASE.Tsetmin{2}=    [   15,     15,     15  ];
BASE.Tsetmax{2}=	[   24,     24,     24  ];
BASE.RVmin{2}=		[	-1,		-1,		-1	];
BASE.RVmax{2}=		[	100,	100,	100	];
...
BASE.Tfc{3}=		[	25, 	25, 		25	];
BASE.Qint{3}=		[	221.6,	221.6,		221.6	];
BASE.Gint{3}=		[(1108/9)*1e-5, 	(1108/9)*1e-5,	    (1108/9)*1e-5];
BASE.Tsetmin{3}=	[   10      10,         10  ];
BASE.Tsetmax{3}=	2*[ 25,      25,         25  ];
BASE.RVmin{3}=		[	-1,		-1,		    -1	];
...
BASE.weekfun{1}=			[1, 		1, 		1, 		    1, 		    1, 		    2, 		    2];
BASE.weekfun{2}=			[2, 		2, 		2, 		    2, 		    2, 		    3, 		    3];
BASE.weekfun{3}=			[2, 		2, 		2, 		    2, 		    2, 		    3, 		    3];
BASE.weekfun{4}=			[2, 		2, 		2, 		    2, 		    2, 		    3, 		    3];
...
BASE.Plant{1}=[-1,0,0.00,-0.00];
BASE.Plant{2}=[-1,0,0.00,-0.00];
BASE.Plant{3}=[-1,0,0.00,-0.00];
BASE.Plant{4}=[-1,0,0.00,-0.00];
...
% Output containes all calculated data. Weather data are in InClimate. With
% these file the program wavoouput makes some plots. Type 'help_wavooutput' to
% see the explanation of the content of Output and of InClimate  

[Output]=Xwavox1205(Profiles,InClimate,InBuil,Control);
