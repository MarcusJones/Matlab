function y=statistics(s,varargin)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% calculates statistical values for each parameter
% varargin = year,season,month,week,day: 1=calculate, everything else = don't calculate
% june 16, 2005, TUe, PBE, MM
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
if length(varargin)==5
    caly=varargin{1};                                 % calculate years?
    cals=varargin{2};                                 % calculate seasons?
    calm=varargin{3};                                 % calculate months?
    calw=varargin{4};                                 % calculate weeks?
    cald=varargin{5};                                 % calculate days?
else
