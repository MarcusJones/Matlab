...
ADPDisp(SolarJanuaryData,'Solar-27 primärTemp.RL','Solar-24 primärTemp.VL') 

%% State point: enthalpy going into solar collector;
% Temperature 
% Sensor name: Solar-27 primärTemp.RL
sol.n27.col = ADPGetFromHeader(SolarJanuaryData.header,'Solar-27 primärTemp.RL');
...
% Sensor name: Solar-24 primärTemp.VL
% Temperature
sol.n24.col = ADPGetFromHeader(SolarJanuaryData.header,'Solar-24 primärTemp.VL');
